...
- add txHash to balance ([#664](https://github.com/00labs/requestNetwork/issues/664)) ([95bc076](https://github.com/00labs/requestNetwork/commit/95bc076630995d9178f3d5c25324bf3c1d17f03b))
...
- change note type to string ([#622](https://github.com/00labs/requestNetwork/issues/622)) ([4cc80d7](https://github.com/00labs/requestNetwork/commit/4cc80d7ad6f63142210d99117a419804958ca1ba))
- Encryption channel use multi-format for identity instead of hash ([#501](https://github.com/00labs/requestNetwork/issues/501)) ([500a724](https://github.com/00labs/requestNetwork/commit/500a724010e6fefa26ec3e6c445df95fe32c6ebe))
- enhance node synchronization and storing of ignored data ([#205](https://github.com/00labs/requestNetwork/issues/205)) ([fb6add2](https://github.com/00labs/requestNetwork/commit/fb6add27b0507e5db3a19682dbcda90274ab19f1))
- guard from replay attack in request logic ([#255](https://github.com/00labs/requestNetwork/issues/255)) ([2dc1fd2](https://github.com/00labs/requestNetwork/commit/2dc1fd24f90f99a21dc599031a4e06dfae38f62c))
...
- topic can be any not only string ([#219](https://github.com/00labs/requestNetwork/issues/219)) ([8d8b601](https://github.com/00labs/requestNetwork/commit/8d8b6014759ca50b1152b98b1faf4888b732b327))
...
- type error in the return of getRequestById() ([#185](https://github.com/00labs/requestNetwork/issues/185)) ([979751e](https://github.com/00labs/requestNetwork/commit/979751ea348c2f6d8454897973f6609b132bf1c6))
...
- use last synched block timestamp as the sync timestamp instead of now ([#481](https://github.com/00labs/requestNetwork/issues/481)) ([81c8cd6](https://github.com/00labs/requestNetwork/commit/81c8cd6671ff7e80f182213205470c58647e7ef2))

### Features

- add an option to disable payment detection in the request client ([#201](https://github.com/00labs/requestNetwork/issues/201)) ([035302f](https://github.com/00labs/requestNetwork/commit/035302f70f86fe914d2970417c4b55a6e0a32eda))
...
- add delegate in request client ([#541](https://github.com/00labs/requestNetwork/issues/541)) ([253b308](https://github.com/00labs/requestNetwork/commit/253b30847f261840508a14cabf5dea93bb7c5dba))
...
- add ERC20 fee proxy contract PN payment detection ([#254](https://github.com/00labs/requestNetwork/issues/254)) ([bec5fac](https://github.com/00labs/requestNetwork/commit/bec5fac0ee7dbbd4f3af5cf9a627627fcc689e14))
- add ERC20 payment network ([#568](https://github.com/00labs/requestNetwork/issues/568)) ([8d820d4](https://github.com/00labs/requestNetwork/commit/8d820d46274e2177454600f7572d3fbede922fe5))
- add extension data at request creation ([#897](https://github.com/00labs/requestNetwork/issues/897)) ([1ca2363](https://github.com/00labs/requestNetwork/commit/1ca2363b08284fe04e481cccdf768db0f5016e24))
...
- add network as declarative params ([#665](https://github.com/00labs/requestNetwork/issues/665)) ([e3a4515](https://github.com/00labs/requestNetwork/commit/e3a4515e23261b79a377ff8ce3d7a5c8d8e84127))
- add the identity ethereumSmartContract to the request logic ([#218](https://github.com/00labs/requestNetwork/issues/218)) ([66d97e0](https://github.com/00labs/requestNetwork/commit/66d97e00dee7305088cb94a0edf542fe4d0bbd56))
- amount are only number or string ([#223](https://github.com/00labs/requestNetwork/issues/223)) ([7a35bde](https://github.com/00labs/requestNetwork/commit/7a35bde63f78b9305819a80e97022fca7e9494d2))
...
- erc777 superfluid get balance of subsequent requests ([#900](https://github.com/00labs/requestNetwork/issues/900)) ([fd491d0](https://github.com/00labs/requestNetwork/commit/fd491d07bfc48d5f5d2a9cd112d28a2485fea9aa))
- **declarative:** payment reference ([#901](https://github.com/00labs/requestNetwork/issues/901)) ([2679368](https://github.com/00labs/requestNetwork/commit/2679368241ea8e34fc88f60eb395459c3c277029))
- add declarative payment network for erc20 ([#635](https://github.com/00labs/requestNetwork/issues/635)) ([ecf4a9d](https://github.com/00labs/requestNetwork/commit/ecf4a9d5515d5eea59e017b9aaf89c133421d71b)), closes [#631](https://github.com/00labs/requestNetwork/issues/631) [#633](https://github.com/00labs/requestNetwork/issues/633) [#636](https://github.com/00labs/requestNetwork/issues/636) [#637](https://github.com/00labs/requestNetwork/issues/637) [#638](https://github.com/00labs/requestNetwork/issues/638) [#550](https://github.com/00labs/requestNetwork/issues/550)
...
- add getIgnoredData() to the ethereum storage ([#206](https://github.com/00labs/requestNetwork/issues/206)) ([255d2dc](https://github.com/00labs/requestNetwork/commit/255d2dc22ce0158ba3e6ce6766efece6e4c054cb))
- add proxy contract to eth input data in payment detection ([#140](https://github.com/00labs/requestNetwork/issues/140)) ([0c36de1](https://github.com/00labs/requestNetwork/commit/0c36de12d08b1b591a7fd282d2cac1e5f38adb24))
...
- address based pn inherits from declarative ([#620](https://github.com/00labs/requestNetwork/issues/620)) ([cb9695e](https://github.com/00labs/requestNetwork/commit/cb9695eb9bf0c0180b1524a11aab9e52c5f3299b))
- confirmed & pending state in the highest layers ([#119](https://github.com/00labs/requestNetwork/issues/119)) ([9424dc0](https://github.com/00labs/requestNetwork/commit/9424dc0c9482208fdbe714f8d29f5deed68711de))
- emits "error" event when the confirmation fails ([#179](https://github.com/00labs/requestNetwork/issues/179)) ([73bfcfb](https://github.com/00labs/requestNetwork/commit/73bfcfb5f6a54d2036a47e09ce180a00c12a81ae))
- ERC20 fees payment network extension ([#251](https://github.com/00labs/requestNetwork/issues/251)) ([95af529](https://github.com/00labs/requestNetwork/commit/95af529c168734ea5018d9220c127fe115f2ac37))
- escrow detector class ([#773](https://github.com/00labs/requestNetwork/issues/773)) ([c4c2276](https://github.com/00labs/requestNetwork/commit/c4c22765df68a6438e4a0e9bc3d6255e844da791))
- Escrow payment detection library ([#712](https://github.com/00labs/requestNetwork/issues/712)) ([5b2bd70](https://github.com/00labs/requestNetwork/commit/5b2bd7066049b843bb33ddc498220aa4e3741ee0))
- goerli storage ([#890](https://github.com/00labs/requestNetwork/issues/890)) ([6aa9849](https://github.com/00labs/requestNetwork/commit/6aa9849e7c5795de6ec3cbd2a1607af15416a833))
- implementation of delegation in declarative pn ([#535](https://github.com/00labs/requestNetwork/issues/535)) ([cf4eac7](https://github.com/00labs/requestNetwork/commit/cf4eac7665f5d797e2768c888fc87f470fe4f8cf))
- native tokens payment extension ([#574](https://github.com/00labs/requestNetwork/issues/574)) ([0d2bb4f](https://github.com/00labs/requestNetwork/commit/0d2bb4fb28a6099d8a87b740061d350b10255c60))
- Near detection with autobahn ([#576](https://github.com/00labs/requestNetwork/issues/576)) ([86e0145](https://github.com/00labs/requestNetwork/commit/86e01459a6b32dacfa778434226f374f7668786c))
- optionally disable events ([#469](https://github.com/00labs/requestNetwork/issues/469)) ([e16a926](https://github.com/00labs/requestNetwork/commit/e16a926cc182a0048909de5cfe1cdd5f9772a153))
- payment detection error does not throw ([#163](https://github.com/00labs/requestNetwork/issues/163)) ([f49640b](https://github.com/00labs/requestNetwork/commit/f49640b264c1350f1a7b0001fd71736f8bf3dc23))
- payment detection for ethereum fee proxy ([#585](https://github.com/00labs/requestNetwork/issues/585)) ([c78803f](https://github.com/00labs/requestNetwork/commit/c78803fb1333917b843db935df0114a50e294f5f))
- Payment detection for the any to erc20 payment network ([#419](https://github.com/00labs/requestNetwork/issues/419)) ([6f7338f](https://github.com/00labs/requestNetwork/commit/6f7338f42ddf793a733a31b434d6116beebefdf6))
- payment network any to erc20 in advanced logic ([#414](https://github.com/00labs/requestNetwork/issues/414)) ([45f09f9](https://github.com/00labs/requestNetwork/commit/45f09f9ee5693378722559d414b07e887fb3c63c))
- Payment network any-to-eth in the advanced logic ([#599](https://github.com/00labs/requestNetwork/issues/599)) ([4f113c9](https://github.com/00labs/requestNetwork/commit/4f113c9b5c9df9adfccc828a4f64b5c6e6f12b49))
- Payment network any-to-eth in the payment detection ([#605](https://github.com/00labs/requestNetwork/issues/605)) ([b830d46](https://github.com/00labs/requestNetwork/commit/b830d4690625754c33c4a6262d96e490de768a10))
- Payment network any-to-eth in the payment processor ([#610](https://github.com/00labs/requestNetwork/issues/610)) ([a7c12ac](https://github.com/00labs/requestNetwork/commit/a7c12ac3c28dd6b4f144f10bad1223ed5c48d02e))
- payment network ethereum fee proxy in advanced logic ([#582](https://github.com/00labs/requestNetwork/issues/582)) ([b32c85d](https://github.com/00labs/requestNetwork/commit/b32c85de82cf6aea6ac7f406e339180f7e2d9218))
- payment processing for ethereum fee proxy ([#587](https://github.com/00labs/requestNetwork/issues/587)) ([2b1c04c](https://github.com/00labs/requestNetwork/commit/2b1c04c112b732431fdfd342da8c60f233ef0819))
...
- remove hash in encrypted transaction ([#232](https://github.com/00labs/requestNetwork/issues/232)) ([d58f101](https://github.com/00labs/requestNetwork/commit/d58f101f9f76e408671dd1edb0d67863d1c8abd5))
- replace symmetric encryption algorithm by aes-256-gcm ([#233](https://github.com/00labs/requestNetwork/issues/233)) ([969bebe](https://github.com/00labs/requestNetwork/commit/969bebeb99b4bc2fdd31405a162934cfdff6db05))
- retrieve active escrow data ([#818](https://github.com/00labs/requestNetwork/issues/818)) ([0bcf58c](https://github.com/00labs/requestNetwork/commit/0bcf58cdad76d42320f22065207f82455d4a12fe))
- sf advanced logic subsequent request ([#899](https://github.com/00labs/requestNetwork/issues/899)) ([43adccf](https://github.com/00labs/requestNetwork/commit/43adccff2b99e3268ea21e1a23b3a7f3cbdf3461))
...
- SuperFluid advanced logic ([#797](https://github.com/00labs/requestNetwork/issues/797)) ([de5ef06](https://github.com/00labs/requestNetwork/commit/de5ef06e50a7950d49d35dfe318c01190a6a91e5))
...
- xdai gas price ([#457](https://github.com/00labs/requestNetwork/issues/457)) ([8f0822d](https://github.com/00labs/requestNetwork/commit/8f0822de91cb2d9f617fa94c4d11dcd9adf806b2))
- **advanced-logic:** add ERC20 proxy contract payment network ([#74](https://github.com/00labs/requestNetwork/issues/74)) ([031a374](https://github.com/00labs/requestNetwork/commit/031a3742d2dddc0324e75b7853287d252bf43c6c))
- add IPFS peer for faster IPFS retrieval, and check IPFS and Ethereum nodes connections ([#353](https://github.com/00labs/requestNetwork/issues/353)) ([47358c2](https://github.com/00labs/requestNetwork/commit/47358c2bad8b5c40e0d4c2c240b9e856592858e4))
- add multi-format package to serialize and deserialize data ([#546](https://github.com/00labs/requestNetwork/issues/546)) ([2b03cd1](https://github.com/00labs/requestNetwork/commit/2b03cd19f02ebc1e37f6253fec7aa13699165a3c))
...
- asynchronously pin IPFS files in batches ([#403](https://github.com/00labs/requestNetwork/issues/403)) ([926c22b](https://github.com/00labs/requestNetwork/commit/926c22b326e7cd7dc800fc89302bc19cf1105c4f))
...
- class to get Ethereum block information in storage ([#283](https://github.com/00labs/requestNetwork/issues/283)) ([1454981](https://github.com/00labs/requestNetwork/commit/1454981e01d10e378909279d3f96e2ac8796eedf))
- compute the requestId before creation with computeRequestId ([#407](https://github.com/00labs/requestNetwork/issues/407)) ([c88c6f6](https://github.com/00labs/requestNetwork/commit/c88c6f69ce0a28c0cf1edd321db50b0288c48739))
- Data access interface ([#161](https://github.com/00labs/requestNetwork/issues/161)) ([ccb4481](https://github.com/00labs/requestNetwork/commit/ccb448161607867f64929ae89e9189b1427067cd))
- declarative requests on request-client.js ([#318](https://github.com/00labs/requestNetwork/issues/318)) ([c4a4cb5](https://github.com/00labs/requestNetwork/commit/c4a4cb5c575e37da64ee180af2bdb840cdbb5e8a))
- determines gas price automatically on mainnet ([#429](https://github.com/00labs/requestNetwork/issues/429)) ([3d42c75](https://github.com/00labs/requestNetwork/commit/3d42c75a3a6544541fe0197a1fd69f49a873430a))
- ETH payement network in advanced-logic ([#589](https://github.com/00labs/requestNetwork/issues/589)) ([7b32ce8](https://github.com/00labs/requestNetwork/commit/7b32ce84c23ee723a143d752fb93786a6c5cc813))
- Ethereum Private key (Epk) decryption provider implementation ([#499](https://github.com/00labs/requestNetwork/issues/499)) ([207b762](https://github.com/00labs/requestNetwork/commit/207b76213628570d346decd4ec5a7912ddb2bf09))
- get requests by multiple topics or multiple identities ([#530](https://github.com/00labs/requestNetwork/issues/530)) ([8fe7d30](https://github.com/00labs/requestNetwork/commit/8fe7d300336eba1ba983a95122579b5adfddbc96))
- validate role for increase & decrease ([#590](https://github.com/00labs/requestNetwork/issues/590)) ([4793782](https://github.com/00labs/requestNetwork/commit/47937828a0f42e912eda440be4e277f26aa51bdb))
- Validation of accept, cancel and add extension data ([#599](https://github.com/00labs/requestNetwork/issues/599)) ([8f7798e](https://github.com/00labs/requestNetwork/commit/8f7798e6e71819e5201efaf73678ff5b71b52503))
- **data-access:** get channels from multiple topics ([#527](https://github.com/00labs/requestNetwork/issues/527)) ([bdebab7](https://github.com/00labs/requestNetwork/commit/bdebab735bd29c781f186e7c17840d747361a836))
...
- **transaction-manager:** add transaction to an existing encrypted channel ([#524](https://github.com/00labs/requestNetwork/issues/524)) ([027a0f5](https://github.com/00labs/requestNetwork/commit/027a0f56c42790a3a5f5aa700383f0144dd1206e))
- **transaction-manager:** decrypt channels ([#516](https://github.com/00labs/requestNetwork/issues/516)) ([8142c3d](https://github.com/00labs/requestNetwork/commit/8142c3dda149ad00513dae8c6d9f15a74aebf7b7))
...
- getTransactionByTopic with timestamp boundaries ([#294](https://github.com/00labs/requestNetwork/issues/294)) ([be4ec56](https://github.com/00labs/requestNetwork/commit/be4ec5618f63f8c42d87dfa450d26518f0ed5deb))
- implement the client-side library with mocked http calls ([#186](https://github.com/00labs/requestNetwork/issues/186)) ([de883ff](https://github.com/00labs/requestNetwork/commit/de883ff4f622d8de070a96a91eb2b79aa8afa65d))
...
- IPFS retry on error ([#421](https://github.com/00labs/requestNetwork/issues/421)) ([18d6e6e](https://github.com/00labs/requestNetwork/commit/18d6e6ea1596db91147dc94881458995a6ab5c6d))
- Migrate the synchronization from storage to data-access ([#292](https://github.com/00labs/requestNetwork/issues/292)) ([3d04d0d](https://github.com/00labs/requestNetwork/commit/3d04d0dc31a9c94c7acd8caee5126f1846589558))
- mock storage for dev mode ([#192](https://github.com/00labs/requestNetwork/issues/192)) ([af0d580](https://github.com/00labs/requestNetwork/commit/af0d580d6eddabbdec38d9e38239de4f422e84e0))
- payment network declarative for any currency ([#315](https://github.com/00labs/requestNetwork/issues/315)) ([06fb561](https://github.com/00labs/requestNetwork/commit/06fb561e93ba2f496157b97eb58a25b9550d8f35))
- persist encrypted transaction in transaction manager ([#495](https://github.com/00labs/requestNetwork/issues/495)) ([7523f93](https://github.com/00labs/requestNetwork/commit/7523f930a66b9ba0fa8d71a6238c908e09369ab6))
- Request logic: create encrypted request ([#496](https://github.com/00labs/requestNetwork/issues/496)) ([9f1ebe6](https://github.com/00labs/requestNetwork/commit/9f1ebe67c19bacecd20b9288fd91ce85ad7baf28))
...
- Storage module ([#157](https://github.com/00labs/requestNetwork/issues/157)) ([bea2b50](https://github.com/00labs/requestNetwork/commit/bea2b50b50b44a5f78d2c49cdfbdb5f2d0ad883f))
...
- Transaction-manager: ignore the wrong transactions of channels ([#514](https://github.com/00labs/requestNetwork/issues/514)) ([4ec82c6](https://github.com/00labs/requestNetwork/commit/4ec82c695536e028e17b9b16e76cf366bd9b7965))
- upgradable smart contracts ([#337](https://github.com/00labs/requestNetwork/issues/337)) ([c8cf724](https://github.com/00labs/requestNetwork/commit/c8cf7249978f4c892b92a3cdcab98a32427c65a5))
...
- Revert "Simplify the types of request-logic" ([f7e0857](https://github.com/00labs/requestNetwork/commit/f7e08571c5287981f8b7307681421cc591c0077d))
...
- implement the client-side library with mocked http calls ([#186](https://github.com/RequestNetwork/requestNetwork/issues/186)) ([de883ff](https://github.com/RequestNetwork/requestNetwork/commit/de883ff4f622d8de070a96a91eb2b79aa8afa65d))
...
# [0.35.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.35.0) (2021-06-22)
...
# [0.34.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.34.0) (2021-05-12)
...
# [0.33.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.33.0) (2021-04-19)
...
# [0.32.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.32.0) (2021-03-25)
...
# [0.31.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.31.0) (2021-03-15)
...
# [0.30.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.30.0) (2021-03-03)

### Features

- payment network any to erc20 in advanced logic ([#414](https://github.com/RequestNetwork/requestNetwork/issues/414)) ([45f09f9](https://github.com/RequestNetwork/requestNetwork/commit/45f09f9ee5693378722559d414b07e887fb3c63c))

## [0.29.3](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.29.3) (2021-02-22)

**Note:** Version bump only for package @huma-shan/types

## [0.29.2](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.29.2) (2020-12-22)

**Note:** Version bump only for package @huma-shan/types

## [0.29.1](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.29.0...@huma-shan/types@0.29.1) (2020-12-21)

**Note:** Version bump only for package @huma-shan/types

# [0.29.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.29.0) (2020-12-02)
...
# [0.28.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.28.0) (2020-11-12)
...
# [0.27.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.27.0) (2020-11-05)
...
# [0.26.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.26.0) (2020-10-21)
...
# [0.25.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.25.0) (2020-10-14)
...
# [0.24.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.24.0) (2020-10-13)
...
# [0.23.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.23.0) (2020-10-09)
...
# [0.22.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.22.0) (2020-09-28)
...
# [0.21.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.21.0) (2020-09-18)
...
# [0.20.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.20.0) (2020-09-01)
...
# [0.19.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.19.0) (2020-08-27)
...
# [0.18.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.18.0) (2020-08-13)
...
# [0.17.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.17.0) (2020-06-29)
...
# [0.16.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.16.0) (2020-05-04)
...
# [0.15.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.15.0) (2020-04-21)
...
# [0.14.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.14.0) (2020-04-06)
...
# [0.13.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.13.0) (2020-03-23)
...
# [0.12.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.12.0) (2020-02-20)
...
# [0.11.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.11.0) (2020-01-16)
...
# [0.10.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.10.0) (2019-12-18)
...
## [0.9.1](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.9.0...@huma-shan/types@0.9.1) (2019-12-04)

**Note:** Version bump only for package @huma-shan/types

# [0.9.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.8.0...@huma-shan/types@0.9.0) (2019-11-20)
...
# [0.8.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.7.0...@huma-shan/types@0.8.0) (2019-10-21)
...
# [0.7.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.6.0...@huma-shan/types@0.7.0) (2019-09-16)
...
# [0.6.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.5.0...@huma-shan/types@0.6.0) (2019-09-05)
...
# [0.5.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.4.0...@huma-shan/types@0.5.0) (2019-08-19)
...
# [0.3.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.1.1-alpha.3...@huma-shan/types@0.3.0) (2019-07-24)
...
## [0.2.1-alpha.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.1.1-alpha.3...@huma-shan/types@0.2.1-alpha.0) (2019-07-22)
...
# [0.2.0](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.1.1-alpha.3...@huma-shan/types@0.2.0) (2019-06-06)
...
## [0.1.1-alpha.11](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.1.1-alpha.3...@huma-shan/types@0.1.1-alpha.11) (2019-05-21)
...
## [0.1.1-alpha.10](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.1.1-alpha.3...@huma-shan/types@0.1.1-alpha.10) (2019-05-17)
...
## [0.1.1-alpha.9](https://github.com/RequestNetwork/requestNetwork/compare/@huma-shan/types@0.1.1-alpha.3...@huma-shan/types@0.1.1-alpha.9) (2019-05-10)
