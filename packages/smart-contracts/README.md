...
`@huma-shan/smart-contractsde` is a package part of the [Request Network protocol](https://github.com/RequestNetwork/requestNetwork).
...
```bash
npm install @huma-shan/smart-contractsde
```
