...
`@frinkly/epk-signature` is a typescript library part of the [Request Network protocol](https://github.com/RequestNetwork/requestNetwork).
...
```bash
npm install @frinkly/epk-signature
```
