...
`@huma-shan/smart-contracts` is a package part of the [Request Network protocol](https://github.com/RequestNetwork/requestNetwork).
...
```bash
npm install @huma-shan/smart-contracts
```
