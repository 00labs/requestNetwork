...
import { erc20FeeProxyArtifact, erc20SwapToPayArtifact } from '@huma-shan/smart-contractsde';
import { ERC20SwapToPay__factory } from '@huma-shan/smart-contractsde/types';
